    ...
    <>
      ...
      >
        ...
        <div
          className={
            props.disabled
              ? `absolute left-9 -top-2 px-2 transition-all duration-300 ease-in-out font-bold cursor-text text-skin-primary/60 z-[5] peer/label w-fit text-xs md:text-xs peer-placeholder-shown:truncate peer-placeholder-shown:w-auto bg-gradient-to-b from-white from-45% to-[#E9ECEF] to-55%`
